...
//     snacks.length, laundry.length, motorbike.length, sports.length, outdoor.length, boxing.length, furniture.length, cleaner.length
  //  )
    ...
    return (
        <div className="my-8">
            <p className="text-start font-serif font-bold text-3xl py-2">Categories</p>
            <div className="grid shadow-lg bg-base-100 gap-2 grid-cols-2 md:grid-cols-10 lg:grid-cols-10">
             ...
             <Link to = "/allCategory"><p className="bg-gradient-to-r from-amber-700 to-amber-300 py-2  h-7 mt-10 px-4 rounded-xl text-white btn">Show more categories <FaArrowRightLong></FaArrowRightLong> </p> </Link>
        </div>
    );
};
